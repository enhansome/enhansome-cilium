...
* [Cilium](https://github.com/cilium/cilium) ⭐ 25,536 | 🐛 1,100 | 🌐 Go | 📅 2026-09-24 - A networking plugin for various container runtimes such as Kubernetes, Docker, and Mesos. It leverages Linux kernel features like eBPF to provide fast and secure networking and load balancing for applications.
* [Prometheus & Grafana for Cilium](https://github.com/cilium/cilium/tree/main/examples/kubernetes/addons/prometheus) ⭐ 25,536 | 🐛 1,100 | 🌐 Go | 📅 2026-09-24 - Collects metrics from Cilium and stores them in Prometheus for analysis and alerting.
* [eBPF](https://github.com/cilium/ebpf) ⭐ 7,968 | 🐛 31 | 🌐 Go | 📅 2026-09-23 - Technology that allows for dynamic, programmable packet filtering and network analysis in the Linux kernel.
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,936 | 🐛 124 | 🌐 Go | 📅 2026-09-24 - Turns telemetry data into actionable insights, helping you identify and resolve application issues quickly.
* [Pixie](https://github.com/pixie-io/pixie) ⭐ 6,539 | 🐛 396 | 🌐 C++ | 📅 2026-09-24 - Instant Kubernetes-native application observability.
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 5,032 | 🐛 287 | 🌐 C | 📅 2026-09-24 - Runtime security enforcement and observability tool.
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,346 | 🐛 44 | 🌐 Makefile | 📅 2026-09-22 - Network visibility and monitoring tool built by the Cilium community. It provides real-time visibility into network traffic, allowing operators to gain insights into application behavior, troubleshoot connectivity issues, and enforce network security policies.
...
* [Cilium Proxy](https://github.com/cilium/proxy) ⭐ 190 | 🐛 32 | 🌐 C++ | 📅 2026-09-24 - High-performance HTTP, TCP, and gRPC proxy that can be automatically injected into Kubernetes pods. It provides features like load balancing, health checking, and L7 visibility.
...
* [Contributors](https://github.com/cilium/cilium/graphs/contributors) ⭐ 25,536 | 🐛 1,100 | 🌐 Go | 📅 2026-09-24 - Contributions to main.
