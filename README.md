...
* [Cilium](https://github.com/cilium/cilium) ⭐ 24,937 | 🐛 1,089 | 🌐 Go | 📅 2026-08-15 - A networking plugin for various container runtimes such as Kubernetes, Docker, and Mesos. It leverages Linux kernel features like eBPF to provide fast and secure networking and load balancing for applications.
* [Prometheus & Grafana for Cilium](https://github.com/cilium/cilium/tree/main/examples/kubernetes/addons/prometheus) ⭐ 24,937 | 🐛 1,089 | 🌐 Go | 📅 2026-08-15 - Collects metrics from Cilium and stores them in Prometheus for analysis and alerting.
...
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,872 | 🐛 112 | 🌐 Go | 📅 2026-08-14 - Turns telemetry data into actionable insights, helping you identify and resolve application issues quickly.
* [Pixie](https://github.com/pixie-io/pixie) ⭐ 6,513 | 🐛 395 | 🌐 C++ | 📅 2026-07-30 - Instant Kubernetes-native application observability.
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 4,921 | 🐛 255 | 🌐 C | 📅 2026-08-14 - Runtime security enforcement and observability tool.
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,288 | 🐛 45 | 🌐 Makefile | 📅 2026-08-05 - Network visibility and monitoring tool built by the Cilium community. It provides real-time visibility into network traffic, allowing operators to gain insights into application behavior, troubleshoot connectivity issues, and enforce network security policies.
...
* [Cilium Proxy](https://github.com/cilium/proxy) ⭐ 188 | 🐛 29 | 🌐 C++ | 📅 2026-08-15 - High-performance HTTP, TCP, and gRPC proxy that can be automatically injected into Kubernetes pods. It provides features like load balancing, health checking, and L7 visibility.
...
* [Learning ebpf book](https://github.com/lizrice/learning-ebpf) ⭐ 1,800 | 🐛 6 | 🌐 C | 📅 2026-03-23 - Learning eBPF, published by O'Reilly! Here's where you will find a VM config for the examples.
...
* [Contributors](https://github.com/cilium/cilium/graphs/contributors) ⭐ 24,937 | 🐛 1,089 | 🌐 Go | 📅 2026-08-15 - Contributions to main.
