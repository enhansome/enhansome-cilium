...
* [Cilium](https://github.com/cilium/cilium) ⭐ 25,045 | 🐛 1,088 | 🌐 Go | 📅 2026-09-02 - A networking plugin for various container runtimes such as Kubernetes, Docker, and Mesos. It leverages Linux kernel features like eBPF to provide fast and secure networking and load balancing for applications.
* [Prometheus & Grafana for Cilium](https://github.com/cilium/cilium/tree/main/examples/kubernetes/addons/prometheus) ⭐ 25,045 | 🐛 1,088 | 🌐 Go | 📅 2026-09-02 - Collects metrics from Cilium and stores them in Prometheus for analysis and alerting.
...
* [Pixie](https://github.com/pixie-io/pixie) ⭐ 6,529 | 🐛 395 | 🌐 C++ | 📅 2026-07-30 - Instant Kubernetes-native application observability.
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 4,980 | 🐛 270 | 🌐 C | 📅 2026-09-02 - Runtime security enforcement and observability tool.
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,320 | 🐛 44 | 🌐 Makefile | 📅 2026-09-01 - Network visibility and monitoring tool built by the Cilium community. It provides real-time visibility into network traffic, allowing operators to gain insights into application behavior, troubleshoot connectivity issues, and enforce network security policies.
* [Packet, where are you?](https://github.com/cilium/pwru) ⭐ 3,820 | 🐛 41 | 🌐 C | 📅 2026-08-28 - eBPF-based Linux kernel networking debugger.
...
* [Cilium Proxy](https://github.com/cilium/proxy) ⭐ 188 | 🐛 34 | 🌐 C++ | 📅 2026-09-02 - High-performance HTTP, TCP, and gRPC proxy that can be automatically injected into Kubernetes pods. It provides features like load balancing, health checking, and L7 visibility.
...
* [Contributors](https://github.com/cilium/cilium/graphs/contributors) ⭐ 25,045 | 🐛 1,088 | 🌐 Go | 📅 2026-09-02 - Contributions to main.
