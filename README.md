...
* [Cilium](https://github.com/cilium/cilium) ⭐ 25,382 | 🐛 1,117 | 🌐 Go | 📅 2026-09-20 - A networking plugin for various container runtimes such as Kubernetes, Docker, and Mesos. It leverages Linux kernel features like eBPF to provide fast and secure networking and load balancing for applications.
* [Prometheus & Grafana for Cilium](https://github.com/cilium/cilium/tree/main/examples/kubernetes/addons/prometheus) ⭐ 25,382 | 🐛 1,117 | 🌐 Go | 📅 2026-09-20 - Collects metrics from Cilium and stores them in Prometheus for analysis and alerting.
* [eBPF](https://github.com/cilium/ebpf) ⭐ 7,964 | 🐛 26 | 🌐 Go | 📅 2026-09-17 - Technology that allows for dynamic, programmable packet filtering and network analysis in the Linux kernel.
* [Coroot](https://github.com/coroot/coroot) ⭐ 7,928 | 🐛 120 | 🌐 Go | 📅 2026-09-18 - Turns telemetry data into actionable insights, helping you identify and resolve application issues quickly.
* [Pixie](https://github.com/pixie-io/pixie) ⭐ 6,537 | 🐛 396 | 🌐 C++ | 📅 2026-07-30 - Instant Kubernetes-native application observability.
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 5,020 | 🐛 284 | 🌐 C | 📅 2026-09-20 - Runtime security enforcement and observability tool.
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,341 | 🐛 44 | 🌐 Makefile | 📅 2026-09-15 - Network visibility and monitoring tool built by the Cilium community. It provides real-time visibility into network traffic, allowing operators to gain insights into application behavior, troubleshoot connectivity issues, and enforce network security policies.
* [Packet, where are you?](https://github.com/cilium/pwru) ⭐ 3,830 | 🐛 39 | 🌐 C | 📅 2026-09-19 - eBPF-based Linux kernel networking debugger.
...
* [Cilium Proxy](https://github.com/cilium/proxy) ⭐ 190 | 🐛 34 | 🌐 C++ | 📅 2026-09-20 - High-performance HTTP, TCP, and gRPC proxy that can be automatically injected into Kubernetes pods. It provides features like load balancing, health checking, and L7 visibility.
...
* [Learning ebpf book](https://github.com/lizrice/learning-ebpf) ⭐ 1,820 | 🐛 6 | 🌐 C | 📅 2026-03-23 - Learning eBPF, published by O'Reilly! Here's where you will find a VM config for the examples.
...
* [Contributors](https://github.com/cilium/cilium/graphs/contributors) ⭐ 25,382 | 🐛 1,117 | 🌐 Go | 📅 2026-09-20 - Contributions to main.
