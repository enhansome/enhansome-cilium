...
* [Cilium](https://github.com/cilium/cilium) ⭐ 25,085 | 🐛 1,097 | 🌐 Go | 📅 2026-09-06 - A networking plugin for various container runtimes such as Kubernetes, Docker, and Mesos. It leverages Linux kernel features like eBPF to provide fast and secure networking and load balancing for applications.
* [Prometheus & Grafana for Cilium](https://github.com/cilium/cilium/tree/main/examples/kubernetes/addons/prometheus) ⭐ 25,085 | 🐛 1,097 | 🌐 Go | 📅 2026-09-06 - Collects metrics from Cilium and stores them in Prometheus for analysis and alerting.
* [eBPF](https://github.com/cilium/ebpf) ⭐ 7,944 | 🐛 26 | 🌐 Go | 📅 2026-09-03 - Technology that allows for dynamic, programmable packet filtering and network analysis in the Linux kernel.
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 4,987 | 🐛 284 | 🌐 C | 📅 2026-09-05 - Runtime security enforcement and observability tool.
...
* [Contributors](https://github.com/cilium/cilium/graphs/contributors) ⭐ 25,085 | 🐛 1,097 | 🌐 Go | 📅 2026-09-06 - Contributions to main.
